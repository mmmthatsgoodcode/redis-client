...
public abstract class AbstractResponse<T> extends Protocol implements Response<T> {
	
	private final static Logger LOG = LoggerFactory.getLogger(AbstractResponse.class);
	...
	public AbstractResponse(ByteBuf in) {
		this.in = in;

	}
	
	/* (non-Javadoc)
	 * @see com.mmmthatsgoodcode.redis.protocol.Response#value()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mmmthatsgoodcode.redis.protocol.Response#decode()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mmmthatsgoodcode.redis.protocol.Response#setRequest(com.mmmthatsgoodcode.redis.protocol.Request)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.mmmthatsgoodcode.redis.protocol.Response#getRequest()
	 */
	@Override
