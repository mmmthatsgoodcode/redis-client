...
import com.mmmthatsgoodcode.redis.RedisClient.Builder;
...
public class RedisDisruptorClient extends RedisClient {

	public static class Builder extends RedisClient.Builder<RedisDisruptorClient> {
		...
		public RedisDisruptorClient build() {
			...
			return new RedisDisruptorClient(hosts, eventLoopGroup, protocol, hashFunction, connectionsPerHost, channelOptions, shouldHash, connectionRecovery, processingWaitStrategy, processingBufferSize, monitors, withTrafficLogging);
	...
	protected RedisDisruptorClient(List<HostInfo> hosts, EventLoopGroup eventLoopGroup, Protocol protocol, HashFunction hashFunction,
